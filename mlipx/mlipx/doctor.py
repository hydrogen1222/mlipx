...
def run_diagnostics(
    ...
    for engine_name, module_name, install_cmd in (
        (
            "MACE engine",
            "mace",
            "install in .venv-mace; see mlipx/docs/README_CN.md or README_EN.md",
        ),
        ...
        checks.append(
            {
                ...
                "detail": (
                    ...
                    "\n  See the Multi-Engine Guide in mlipx/docs/README_EN.md"
                    " or README_CN.md."
                ),
            }
        )
        ...
        checks.append(
            {
                ...
                "value": "not installed",
                "status": "fail",
                "detail": "Install: cd mlipx && uv pip install -e .",
            }
        )
        failures += 1
